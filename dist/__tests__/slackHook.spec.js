...
import { SlackTransport } from "../index.js";
describe("Standard options", () => {
    ...
    it("log function gets called with correct params", () => {
        ...
        expect(fakeSlackHook.axiosInstance.post).toHaveBeenCalledWith(fakeOpts.webhookUrl, fakePayload);
    });
});
...
//# sourceMappingURL=slackHook.spec.js.map